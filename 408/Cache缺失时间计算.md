![](assets/Cache缺失时间计算/file-20260503142123733.png)
...
![](assets/Cache缺失时间计算/file-20260503142123739.png)
...
![](assets/Cache缺失时间计算/file-20260503142123716.png)
...
- **缺失损失计算**： $$ 1 + 1 \times 10 + 4 \times 1 = 15 \text{ 个时钟周期} $$
  ![](assets/Cache缺失时间计算/file-20260503142123709.png)
>很像[多体并行存储器](多体并行存储器.md),是轮流启动的
