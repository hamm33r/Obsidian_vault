...
- 所以$a = 2, b = 0$答案选B
- 除了将x改写，还有另一种这个极限的解法
- 在[在对数中提取公因子](计算技巧.md#在对数中提取公因子)中，在$e^{2x - 1}$里提取一个$e^{2x}$原式变成$$\lim_{x \to +\infty}\ln\left(e^{2x}\left(1-e^{-2x}\right)\right) - 2x=\ln e^{2x}+\ln\left(1-e^{-2x}\right) - 2x = \lim_{x \to +\infty}$$