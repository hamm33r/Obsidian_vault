...
---
## 第一种$\alpha$ 取整数,e的幂是一次的情况 $$\Gamma(\alpha) = \int_{0}^{+\infty} x^{\alpha-1} \mathrm{e}^{-x} \mathrm{d}x$$
...
## 第二种,$\alpha$是分数,e的幂次是平方的情况
#### $$2\int_{0}^{+\infty} t^{2\alpha-1} \mathrm{e}^{-t^2} \mathrm{d}t \quad (x, t > 0) $$$$\Gamma(\frac 12)=2\int_{0}^{+\infty}e^{-t^2}dt=\sqrt \pi$$
### $$ \begin{aligned} &\Gamma(\alpha+1) = \alpha\Gamma(\alpha), \quad \Gamma\left(\frac{1}{2}\right) = \sqrt{\pi} \\ &\Gamma\left(\frac{3}{2}\right) = \Gamma\left(\frac{1}{2}+1\right) = \frac{1}{2}\Gamma\left(\frac{1}{2}\right) = \frac{1}{2}\sqrt{\pi} \\ &\Gamma\left(\frac{5}{2}\right) = \Gamma\left(\frac{3}{2}+1\right) = \frac{3}{2}\Gamma\left(\frac{3}{2}\right) = \frac{3}{4}\sqrt{\pi} \end{aligned} $$